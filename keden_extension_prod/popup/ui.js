...
function renderPreview(data) {
        ...
        section.innerHTML = `
            ...
            <div class="row" style="margin-bottom: 8px;">
                ...
                <div style="width: 60px;">
                    <label style="font-size: 10px; color: #64748b;">Страна</label>
            ...
            if (agent.data) {
                ...
                div.innerHTML = `
                    ...
                    <div style="display: flex; gap: 8px; align-items: center;">
                        <input type="text" class="preview-input" id="prev-agent-bin-${agent.id}" value="${bin}" placeholder="БИН/ИИН">
                        <span style="font-size: 10px; color: #94a3b8; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${name}</span>
                    </div>
                `;
    ...
    if (data.products && data.products.length > 0) {
        ...
        totalsDiv.style.cssText = 'margin-top: 10px; padding: 10px; background: rgba(13, 148, 136, 0.1); border-radius: 8px; border: 1px solid rgba(13, 148, 136, 0.2); font-size: 12px; display: flex; gap: 20px;';
...
function scrapePreviewData() {
    ...
    // Scrape Vehicles ... (no changes needed)
    if (newData.vehicles) {
